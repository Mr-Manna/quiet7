...
export const services: Service[] = [
  {
    ...
    capabilities: [
      ...
      'Art direction',
      'AI-assisted naming & tagline exploration, narrowed by hand',
    ],
  ...
  },
  {
    ...
    capabilities: [
      ...
      'Design systems',
      'Motion & interaction',
      'AI-assisted UX research synthesis & rapid wireframing',
    ],
  ...
  },
  {
    ...
    capabilities: [
      ...
      'AI-assisted code scaffolding, refactors & review',
    ],
  ...
  },
  {
    ...
    capabilities: [
      ...
      'AI-assisted ad copy & campaign variant drafts',
    ],
  ...
  },
  {
    ...
    title: 'Applied AI',
    summary:
      'We use AI where it earns its place — inside design, motion, content and code — to move faster without lowering the bar on judgement.',
    capabilities: [
      'AI-assisted concepting across brand & product design',
      'AI-assisted rough cuts, motion drafts & sound design',
      'AI-assisted copy, content & campaign drafts',
      'AI-assisted scaffolding & code review',
      'Every AI draft is reviewed, edited and finished by hand',
    ],
    tools: ['Midjourney', 'Runway', 'ChatGPT', 'GitHub Copilot'],
  },
];
